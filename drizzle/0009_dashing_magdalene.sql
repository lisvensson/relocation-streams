...
CREATE INDEX "relocation_industry_cluster_index" ON "relocation" USING btree ("industry_cluster");--> statement-breakpoint
CREATE INDEX "relocation_to_municipality_index" ON "relocation" USING btree ("to_municipality");